...
public class LoginAspect {
    ...
    @Before("com.avs.services.security.LoginAspect.doAuthenticate() && args(authentication)")
    ...
    @AfterReturning(value = "com.avs.services.security.LoginAspect.doAuthenticate()",
    ...
    @AfterThrowing("com.avs.services.security.LoginAspect.doAuthenticate() && args(authentication)")
